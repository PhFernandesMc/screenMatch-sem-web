...
import br.dev.fernandes.screenmatch.model.Episodio;
...
public class Principal {
    ...
    public void exibeMenu() throws IOException, InterruptedException {
        ...
        var nomeSerie = leitura.nextLine().replaceAll(" ", "+");
        ...
        Optional<Episodio> epsisodioBuscado = episodios.stream()
                .filter(e -> e.getTitulo().toUpperCase().contains(trechoTitulo.toUpperCase()))
                .findFirst();

        if (epsisodioBuscado.isPresent()) {
            System.out.println("Episódio encontrado!");
            System.out.println("Temporada: " + epsisodioBuscado.get().getTemporada());
            System.out.println("Número episódio: " + epsisodioBuscado.get().getNumeroEpisodio());
        } else {
